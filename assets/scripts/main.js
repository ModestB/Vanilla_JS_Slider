...
// WRITES outputValue to outputEle
...
// To convert input from 0.1s to 10s you need to use timeCorrection = 10
function getSpeed(inputEle, outputEle, timeCorrection = 1){
...
// THEN user selects animation that selection gets class .select-selected
// Using that class name you can extract animation name
...
function getSettings(){
  return {
    animSpeed: getSpeed('#anim-speed', '#anim-speed-out', 10) * 1000,
    slideSpeed: getSpeed('#slide-speed', '#slide-speed-out') * 1000,
...
getSpeed('#anim-speed', '#anim-speed-out', 10)
getSpeed('#slide-speed', '#slide-speed-out')
setSettings()
selectFunctionality()